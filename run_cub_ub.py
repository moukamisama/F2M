...
ROOT_1= './options/train/cub/FSIL/FSIL_train_res18_cub_CFRPModel_upperBound_SGD'
ROOT_2= './options/train/cub/FSIL/FSIL_train_res18_cub_CFRPModel_upperBound2_SGD'
#ID = ['01', '02']
# ID = ['05', '06']
# ID = ['01', '02', '03', '04']
# ID = ['05', '06', '07', '08', '09']
# ID = ['02', '03', '04', '05']
ID = ['01', '02', '03', '04', '07', '05', '06', '08', '09', '10']
GPU = '2'
